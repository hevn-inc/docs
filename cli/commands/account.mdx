...
Every session starts here: which account the CLI is pointed at, which key it is using, and
whether that account is verified enough to move money.
...
<Card title="Next: Contacts" icon="users" href="/cli/commands/contacts">
  Save the email, crypto and bank destinations you will pay.
</Card>
