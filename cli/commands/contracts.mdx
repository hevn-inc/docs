...
A contract is the agreement an invoice can be generated from. Upload one you already signed, or
generate one from a HEVN template; either way the counterparty approves it before it can bill.
...
<Card title="Next: Cards and banks" icon="credit-card" href="/cli/commands/cards-banks">
  Card status and KYC links, bank rails and detail validation.
</Card>
