...
An invoice is a request for payment — one you issued, or one issued to you. The CLI can create them
by hand, read them out of an uploaded document, derive them from a contract, and pay them.
...
```bash
hevn invoice pay <invoice-id> --reference <tx-reference>
```

<Card title="Next: Contracts" icon="file-pen-line" href="/cli/commands/contracts">
