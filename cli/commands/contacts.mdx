...
<Card title="Next: Money movement" icon="arrow-right-left" href="/cli/commands/money-movement">
  Balances, deposit quotes, transactions and transfers.
</Card>
