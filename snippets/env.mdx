...
Nothing crosses between the two environments: developer keys, key registrations, clients, tokens
and rail ids are per-environment, and a sandbox token is refused in production.
