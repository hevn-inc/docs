...
def confirm_until_settled(self, confirm_path: str, signature: str, *, deadline=180.0):
    """A method on Hevn. confirm_path is "/payouts/po_…/confirm" or "/transfers/tr_…/confirm"."""
...
// A method on Hevn. confirmPath is "/payouts/po_…/confirm" or "/transfers/tr_…/confirm".
...
// confirmPath is "/payouts/po_…/confirm" or "/transfers/tr_…/confirm".
