...
flowchart LR
    ...
    subgraph Platform["Platform layer (HEVN)"]
        E["HEVN API + JWT<br/>contacts, invoices, account details"]
    end
    A -->|"authenticates"| B
    B -->|"initial owner"| C
    C --- D
...
- All deposit details (crypto addresses, virtual account details) resolve to this address.
...
| Create invoices, contacts, virtual account details | ✅ via JWT | records them, and requests the account details from a partner bank | opens the virtual account | — |
