...
| HEVN platform | Metadata (contacts, invoices, virtual account details) and the UI you see | Metadata tampering; display is protected by [signed provider responses](/general/architecture#provider-isolation-signed-responses) | No keys, no owner role, no custody — [cannot sign a wallet operation](/general/security-model#failure-scenarios) |
