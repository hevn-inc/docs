...
- **Quotes are firm and verifiable.** The destination address and amount are fixed in the quote before any funds move; the destination for deposits is your own smart wallet address, which you can verify.
...
- **Failure means refund, not loss.** Expired or failed intents follow 1Click's refund flow back to the sender.
