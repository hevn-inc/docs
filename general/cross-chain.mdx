...
A HEVN account's balance is USDC on the user's own Base smart wallet, but users can deposit from and withdraw to many other chains and tokens (BTC, ETH, SOL, TRON-USDT, and more). This is powered by **[NEAR Intents](https://docs.near-intents.org/)** through its **[1Click API](https://docs.near-intents.org/integration/distribution-channels/1click-api/about-1click-api)**.
