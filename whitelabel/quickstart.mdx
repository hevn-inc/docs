...
It never touched fiat. Getting the client its own virtual account requisites, and paying a bank account with a currency
...
[Virtual accounts](/whitelabel/bank-accounts) and [Payouts](/whitelabel/payouts).
