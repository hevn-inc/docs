...
Gate 1 is [creating the client](/whitelabel/clients). Gate 4 is [opening a rail](/whitelabel/virtual-accounts). This page is gates 2 and 3: one document, one readiness list, one submission.
...
<Card title="Next: Virtual accounts" icon="arrow-right" href="/whitelabel/virtual-accounts">
  Check a rail's requirements, open it, and read the account details the client's payers wire to.
</Card>
